...
pca_dataset <- ds[ , c("Acetate", "Lactate", "GlycA", "His", "Gly")]
# pca_dataset <- ds[ , c("Acetate", "XL.HDL.L", "Lactate", "GlycA", "XL.HDL.PL", "XL.HDL.C", "XL.HDL.FC", "XL.HDL.CE", "His", "XL.HDL.P","Gly")]
...
pca_dataset <- ds[ , c("Val", "Leu", "TotalBCAA", "His", "Ile", "Phe")]
# pca_dataset <- ds[ , c("XXL.VLDL.TG", "Val", "Citrate", "Leu", "TotalBCAA", "His", "XXL.VLDL.PL", "XXL.VLDL.L", "VLDLsize", "XXL.VLDL.P",
#                       "Ile", "XXL.VLDL.C", "XXL.VLDL.FC", "Phe")]
